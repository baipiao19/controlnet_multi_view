...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
        ...
        self.instantiate_first_stage(first_stage_config) # ldm.models.autoencoder.AutoencoderKL
        self.instantiate_cond_stage(cond_stage_config) # ldm.modules.encoders.modules.FrozenOpenCLIPEmbedder
